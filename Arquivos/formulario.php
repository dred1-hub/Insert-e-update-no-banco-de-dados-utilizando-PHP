...
<body>
    <div id="divPrincipal">
        <h1 id="cabecalhoForm">Formulário de Cadastro</h1>
        ...
        <div class="alert alert-success" role="alert" >
            Usuário cadastrado com sucesso, caso queira alterar os dados cadastrados <a href="alterarCad.php">Clique aqui!</a>
        </div>
        <?php
        endif;
